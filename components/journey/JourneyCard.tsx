        ...
        <div className="flex items-center gap-3">
          ...
          {onRefresh && (
            <button
              ...
              className="flex h-9 w-9 items-center justify-center rounded-xl bg-slate-100/80 text-slate-600 transition-colors hover:bg-slate-200 dark:bg-slate-800/80 dark:text-slate-300 dark:hover:bg-slate-700 disabled:opacity-60 disabled:cursor-not-allowed"
